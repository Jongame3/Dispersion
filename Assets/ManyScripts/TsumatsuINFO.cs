...
public class TsumatsuINFO : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        if (this.isActiveAndEnabled)
        {
            ...
            Text1.text = "ОЗ: " + jirai.Hp.ToString() + "/" + jirai.maxHp.ToString() +
                "\r\nОУ: " + jirai.SkillPoint.ToString() + "/" + jirai.MaxSkillPoint.ToString() +
                "\r\nОО: " + jirai.DespairPoint.ToString() + "/" + jirai.maxDespairPoint.ToString();
        }
    }
